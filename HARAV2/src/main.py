...
net = Deep_LSTM(39, 4)
net.to(device)
net.load_state_dict(torch.load('../checkpoint/model2_mfl.pth'))
net.eval()
        ...
        try:
            ...
            while True:
                ...
                if len(sequence_tensor) >= current_frame:
                    sequence_tensor = sequence_tensor[3:]
                ...
                if sequence_vector:
                    ...
                    if len(sequence_tensor) == current_frame:
                        ...
                        with torch.no_grad():
                            ...
                            elif outs.item() == 1 : next_status = ['During Walking', (255, 0, 0)]
                            elif outs.item() == 2 : next_status = ['Start Walking', (0, 0, 255)]
