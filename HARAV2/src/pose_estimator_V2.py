...
import numpy as np
from roi_tracker import Tracker, yoloTracker

class PoseEstimator3D:
    def __init__(self,
                 min_detection_confidence=0.5,
                 min_tracking_confidence=0.5,
                 tracker_type="base",  # or "mmtrack" or None
                 roi_padding=40,
                 roi_ratio=0.8):
        ...
        elif tracker_type == "yolotrack":
            self.tracker = yoloTracker(roi_padding, roi_ratio, 0.1, 0.1)
