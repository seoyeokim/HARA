...
from keypoint_preprosessing import keypoint_preprosessing

class DatasetCreater:
    def __init__(self, roi_ratio=0.8, video_path=None, cut_file=None):
        ...
        self.keypoint_preprosessing = keypoint_preprosessing(True)
