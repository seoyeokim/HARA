...
from kalman_filter_remain import KalmanFilterTracker3D
from kalman_filter_remain import KeypointPreprocess
from com_calculator import COMCalculator

class DatasetCreater:
    def __init__(self, roi_ratio=0.8, data_path=None, save_path=None):
...
if __name__ == "__main__":
    ...
    pose_tracking = DatasetCreater(roi_ratio=0.8, data_path=args.load_path, save_path=args.save_path)
    pose_tracking.run()